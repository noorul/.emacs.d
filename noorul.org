...
;; Store sent mails
;; For an exchange server, we need this
;; Gmail does this by default.
...
** Work configuration
#+begin_src emacs-lisp
(let ((work-config-file "~/dropbox-work/.emacs.d/work.org"))
 (if (file-exists-p work-config-file)
     (org-babel-load-file work-config-file)))
#+end_src
** Personal configuration
#+begin_src emacs-lisp
(let ((personal-config-file "~/dropbox-personal/.emacs.d/personal.org"))
