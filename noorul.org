...
(when ha/fixed-font-family
  ...
  (set-face-attribute 'fixed-pitch nil :font ha/fixed-font-family :height 1.0 :weight 'light)
  (set-face-font 'default ha/fixed-font-family))

(when ha/variable-font-family
  (set-face-attribute 'variable-pitch nil :font ha/variable-font-family))
#+end_src
